...
void tlb_write_entry(int index)
{
	...
	case 0x00000000:	/* 4k */
		theTLB->LoCompare = 0x00001000; break;
	case 0x00006000:	/* 16k */
		theTLB->LoCompare = 0x00004000; break;
	case 0x0001E000:	/* 64k */
		theTLB->LoCompare = 0x00010000; break;
	case 0x0007E000:	/* 256k */
		theTLB->LoCompare = 0x00040000; break;
	case 0x001FE000:	/* 1M */
		theTLB->LoCompare = 0x00100000; break;
	case 0x007FE000:	/* 4M */
		theTLB->LoCompare = 0x00400000; break;
	case 0x01FFE000:	/* 16M */
		theTLB->LoCompare = 0x01000000; break;
...
step2:
	...
	if (operation == TLB_INST) { /* here we have got a TLB error at compiling, need to invalidate the compiled block £ and serve the TLB error */
		ITLB_Error = TRUE;
