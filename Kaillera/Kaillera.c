...
int LoadDllKaillera()
{
	...
	pDllKailleraSelectServerDialog  = (int (__stdcall*)(HWND))GetProcAddress(hKailleraDll, "_kailleraSelectServerDialog@4");
	if(pDllKailleraSelectServerDialog == NULL)
		return 0;
	
	pDllKailleraModifyPlayValues  = (int (__stdcall*)(void *values, int size))GetProcAddress(hKailleraDll, "_kailleraModifyPlayValues@8");
