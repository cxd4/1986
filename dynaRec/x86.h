...
extern unsigned __int8 *dyna_CodeTable;
extern unsigned __int8 *dyna_RecompCode;
extern BOOL DynaBufferOverError;

extern void			 SetTranslator(unsigned char *Code, unsigned long Pos, unsigned long Size);
extern unsigned long GetTranslatorPosition();
...
extern void		ADD_ImmToEAX(unsigned char OperandSize, unsigned long Data);
...
extern void		AND_MemoryToReg(unsigned char OperandSize, unsigned char Reg,unsigned long Address);
...
extern void		CMP_MemoryWithImm(unsigned long dwAddress,unsigned char bValue);
...
extern void     LEA(unsigned char OperandSize, unsigned char Reg1,unsigned char Reg2);
...
extern void		MOV_MemoryToReg(unsigned char OperandSize, unsigned char Reg, unsigned char ModRM, unsigned long Address);
extern void		MOV_MemoryToEAX(unsigned char OperandSize, unsigned long Address);
extern void		MOV_RegToMemory(unsigned char OperandSize, unsigned char Reg, unsigned char ModRM, unsigned long Address);
extern void		MOV_Reg16ToMemory(unsigned char Reg,unsigned char ModRM, unsigned long Address);
extern void		MOV_MemoryToReg16(unsigned char Reg,unsigned char ModRM, unsigned long Address);
...
extern void		MOV_ImmToMemory(unsigned char OperandSize, unsigned long Address, unsigned long Data);
...
extern void     MOVSX_MemoryToReg(unsigned char OperandSize, unsigned char Reg, unsigned char ModRM, unsigned long Address);
extern void     MOVZX_MemoryToReg(unsigned char OperandSize, unsigned char Reg, unsigned char ModRM, unsigned long Address);
...
extern void		OR_ImmToMemory(unsigned char OperandSize, unsigned long Immediate,unsigned long Address);
extern void		OR_RegToMemory(unsigned char OperandSize, unsigned char Reg,unsigned long Address);
...
extern void		SUB_ImmToReg(unsigned char Reg,unsigned char data);
...
#define CDQ_STORE(TO_MEM)                                                                \
        ...
        WC16(0xBF99);            WC32(TO_MEM);                                              \
        WC32(0x57890789);        WC8(0x04);
